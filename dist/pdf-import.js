...
function inferType(explanation){
 const rules=[
 [/Rechtschreib|Schreibweise|Grossschreibung|Kleinschreibung|grossgeschrieben|kleingeschrieben|substantiviert|zusammengeschrieben|zusammen.?geschrieben|Zusammensetzung|ohne .{0,12}geschrieben|kleine Anzahl|hinauswollen/i,'Rechtschreibung'],
 [/Fragezeichen/i,'Interpunktion / Fragezeichen'],
 [/Komma/i,'Interpunktion / Komma'],
 [/Doppelpunkt|Semikolon|Anführungszeichen|Zeichenfehler|Gedankenstrich|Ordnungszahl.*Punkt/i,'Interpunktion'],
 [/Bezugsfehler|Pronomen|Pronominal|Genus|feminin|maskulin/i,'Grammatik / Bezug'],
 [/Akkusativ|Dativ|Genitiv|Nominativ/i,'Grammatik / Kasus'],
 [/Artikel/i,'Grammatik / Artikel'],
 [/Präposition|Von-Gruppe|Vor-Gruppe|Verbindung lautet|Verbindung heisst|Verbindung heißt|Verbindung .*verfügen|Verbindung .*leisten|Verbindung .*wagen|mehrteilige Verbindung|Vergleich.*wie|vor einer.*Jahreszahl/i,'Grammatik / Verbindung'],
 [/Partizip|Infinitiv|Modalverb|Verbform|gebeugt|gebeugte|Adjektiv|Adverb|Wortform|Wortbildung|Komparativ|Steigerung/i,'Grammatik / Wortform'],
